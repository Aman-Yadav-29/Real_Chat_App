// This file is used to export all the assets in one place, so that we can easily import them in other files.
...
import Hrithik_Roshan from './Hrithik_Roshan.webp'
import emma from './emma.webp'
import Chris from './Chris.webp'
import Chris_Evans from './Chris_Evans.webp'
...
import chat_background_image from './chat_background_image.avif'

//created one asset object to Export all the assets like images, icons, etc. in one place, so that we can easily import them in other files.
const assets = {
    avatar_icon,
    gallery_icon,
    help_icon,
...
// Exporting dummy data for users, messages and images to use in the application until we have the backend ready.
...
export const userDummyData = [
    ...
    },
    {
        ...
        "fullName": "Hrithik_Roshan",
        "profilePic": Hrithik_Roshan,
        "bio": "Hi Everyone, I am Using QuickChat",
    }
]

// Dummy data for messages, we will use this data to display the messages in the chat window until we have the backend ready.
