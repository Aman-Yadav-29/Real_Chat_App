    ...
    <div className = 'min-h-screen bg-cover bg-center flex items-center justify-center gap-8 sm:justify-evenly max-sm:flex-col backdrop-blur-2xl'>
        ...
        <form onSubmit = {onSubmitHandler} 
         className = 'border-2 bg-white/8 text-white border-gray-500 p-6 flex flex-col gap-6 rounded-lg shadow-lg'>
          ...
          {/* the below code only appear when signing up */}
          ...
          {currState === "Sign up" && isDataSubmitted && (
            ...
            <button type='submit' className='py-3 bg-gradient-to-r from-blue-300 to-blue-500 text-white rounded-full cursor-pointer'>
            ...
            <div className='flex flex-col gap-2'>
                {currState === "Sign up" ? (
                  ...
                  <p className = "text-sm text-gray-500">You do not have an account. Please  &nbsp;
