...
const ChatContainer = ({ selectedUser, setSelectedUser, showRightSidebar, setShowRightSidebar }) => {
  ...
  }, [messagesDummyData]); // fixed dependency
  ...
  return selectedUser ? (
    <div className='h-full overflow-scroll relative backdrop-blur-lg'>
      ...
      <div className='flex items-center gap-3 py-3 mx-4 border-b border-stone-500'>
        <img src={assets.Chris} alt="" className='w-8 rounded-full' />
        <p 
          className='flex-1 text-lg text-white flex items-center gap-2 cursor-pointer hover:underline'
      ...
      <div className='flex flex-col h-[calc(100%-120px)] overflow-y-scroll p-4 pb-6'>
        ...
        <div className = 'absolute bottom-0 left-0 right-0 flex items-center gap-3 p-3'>
          ...
          <div className = 'flex-1 flex items-center bg-gray-100/12 px-3 rounded-full'>
            ...
            {/*accept any type of image like .png, .jpg, .jpeg */}
